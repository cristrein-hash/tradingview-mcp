#!/usr/bin/env python3
"""PLOT confluência macro v2 (ordem Cris 2026-07-13): remove blocos macro anteriores (meus,
preenchimento SÓLIDO hex), mantém desenhos do Cris (translúcidos rgba), plota corridas do
macro_confluence_v2 config (200,10,5,90,-6,120,16,60,3). BULL verde·BEAR vermelho·RANGE laranja.
