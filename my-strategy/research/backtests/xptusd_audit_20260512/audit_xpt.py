#!/usr/bin/env python3
"""XPTUSD deep audit — SWING 4H + INTRADAY 1H with DXY macro filter."""
import pandas as pd
import numpy as np
...
FILES = {
    '1D':  '/Users/cristrein/Downloads/PEPPERSTONE_XPTUSD, 1D_21321.csv',
    '12H': '/Users/cristrein/Downloads/PEPPERSTONE_XPTUSD, 720_2c2dd.csv',
    '4H':  '/Users/cristrein/Downloads/PEPPERSTONE_XPTUSD, 240_d0ab6.csv',
    '1H':  '/Users/cristrein/Downloads/PEPPERSTONE_XPTUSD, 60_5be86.csv',
}
...
def main():
    ...
    for mname, mk in macros:
        for hname, hk in htfs:
            for tname, tfn in swing_trgs:
                ...
                for trg in targets:
                    lbl = f'XPT_SWING_4H_{tname}|{mname}|{hname}|tgt{trg}R'
        ...
        for hname, hk in intra_htfs:
            for tname, tfn in intra_trgs:
                ...
                for trg in intra_targets:
                    lbl = f'XPT_INTRA_1H_{tname}|{mname}|{hname}|tgt{trg}R'
    ...
    res.to_csv(OUT_DIR / 'XPT_audit_summary.csv', index=False)
    ...
    print(f"\nSaved: XPT_audit_summary.csv ({len(res)} configs)")
