...
export A1A2_PRODUCTION_AUTHORIZED=0   # SHADOW (Cris 28/08: valida bom-vs-faca no forward acumulativo; sem live antes disso)      # sinal qualificado "15M BULL" -> Telegram do GRUPO (ordem Cris 05/08)
cd "$(dirname "$0")"
