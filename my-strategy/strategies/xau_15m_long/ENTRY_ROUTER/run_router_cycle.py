...
# RECLAIM = DELETADO DEFINITIVAMENTE (Cris 2026-08-19, scoreboard 1W-14L −11R: 'fraco, cortado').
# RETOMA v1 = DELETADA (arquivada 2026-08-02, prereg reprovado; removida do código 2026-08-19).
# Ledgers históricos ficam em .router_state/ para auditoria; motor reclaim_engine.py removido do repo.
