...
| Caminho A L1 v1 F4+F5 | memory + candidates | LONG · continuation | EMA21_A + sell≤7 + vol≤1.0 | in-sample escasso (n=11) | **SUPERSEDED_BY_L1 / KEEP_REFERENCE** | n pequeno | precursor da L1 (absorvido) |
