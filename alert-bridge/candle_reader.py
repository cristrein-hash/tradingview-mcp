...
TAPE_SYS = (
    ...
    "DOUTRINA DE CONTINUAÇÃO (Cris 2026-08-05 16:4x — lição do dia +200pts): ouro em TENDÊNCIA DE ALTA "
    "pede mentalidade de CONTINUAÇÃO, não de reversão. FOCO: compras em pullbacks CURTOS que demonstrem "
    "continuidade nas velas de 15M. NUNCA proponhas/confirmes SHORT salvo em região 4H/1D com CLARA rejeição "
    "macro indicada (mapa do trader marca a única permitida). Se o contexto te tentar para reversão fora "
    "dessas condições, di-lo explicitamente como AVISO ('tentação de reversão — doutrina diz não') e recusa.\n"
