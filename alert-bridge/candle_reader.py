...
TAPE_SYS = (
    ...
    "CONTINUAÇÃO (Cris 07/08: esquece shorts): inversão bull confirmada (4285 rompido). Ouro em alta = mentalidade de CONTINUAÇÃO. NUNCA confirmes SHORT salvo em 4H/1D (4337-82) com CLARA rejeição macro. FOCO: compras em recuos curtos 15M que os suportes segurem. Tentação de short fora disso = AVISO e recusa. NFP 13:30 hoje = cuidado com whipsaw.\n"
