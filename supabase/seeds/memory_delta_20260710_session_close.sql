...
(
  ...
  'Bloco L1 EMA21 fechado e pushado. (1) Exit review completa: manter +3R fixo (DA PASS) · CHAND_5/trailing/let-run REJEITADOS (knife-edge, 88-92 pct do ganho em 2025, EX-2025 falha). Scanner reconciliado a SL V1 (zona_OB_low-0,1ATR), FINAL-24 reproduz 34/34 (commit 4b58ac9). (2) NAS live causal gate resolvido para dry-run (ledger_frozen i-1, barra fechada, forming excluida · threshold 1.31). (3) Pre-go-live controls: telegram_notify (flag send) exige L1_PRODUCTION_AUTHORIZED=1 · NAS startup fail-closed · capacity_journal.py puro NAO wired (max 2 pos, EUR200 agregado, EUR100/pos, LONG-only, broker MANUAL_APPROVAL_ONLY) (commit 6a32d28). (4) Dry-run live final XAUUSD 4H validado v2: 13 ob_zones reais, scanner evaluate live => no_candidate (regime_d1_not_BULL), tripwire Telegram zero (commit 630b806). PRODUCAO SEGUE NOT_AUTHORIZED · nada de Telegram/broker/daemon/monitor ativado.',
