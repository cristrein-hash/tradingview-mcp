#!/usr/bin/env python3
"""PLOT CANÓNICO — as 10 falhas BULL restantes do gate v2 (sem filtro), como operações de compra.
long_position na vela: entry = preço da marca, SL = −1·ATR, alvo 3R; label laranja FALHA_BULL #n.
...
def main():
    ...
    sel = [r for r in rows if r["status"] == "FALHA" and r["familia"] == "BULL_PULLBACK"]
    D = Data()
