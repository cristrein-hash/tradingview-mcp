...
def knife_v2(r):
    ...
    return a or b
LDON=96; LO=dt.datetime(2025,8,1).timestamp(); HI=dt.datetime(2025,9,2).timestamp()
...
with open(HERE/"deeprange_aug2025.csv","w",newline="") as fh:
...
print(f"FUNDO-PROFUNDO RANGE ago->set/2025: N={len(sel)} WR={100*wn/len(sel) if sel else 0:.0f}% sumR={sm:.1f}")
