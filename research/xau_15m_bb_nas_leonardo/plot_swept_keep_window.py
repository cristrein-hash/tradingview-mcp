...
sel=[t for t in SW if t["cj_t"]>=LO]
...
with open(HERE/"swept_keep_window.csv","w",newline="") as fh:
...
print(f"KEEP-swept-em-cluster de 2025-08-01: N={len(out)} WR={100*wn/len(out):.1f}% sumR={sm:.1f} | {out[0]['date']} -> {out[-1]['date']}")
# plot
