...
sel=[t for t in base if t["_sw"] and LO<=t["cj_t"]<HI]
...
with open(HERE/"sweptsempre_bull.csv","w",newline="") as fh:
...
print(f"swept-sempre ago2025 -> fim BULL (29-jan-2026): N={len(out)} WR={100*wn/len(out):.1f}% sumR={sm:.1f} | {out[0]['date']} -> {out[-1]['date']}")
# plot
