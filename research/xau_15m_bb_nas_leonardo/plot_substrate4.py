...
for r in ROWS:
    ...
    B.append({"cj_t":r["cj_t"],"entry":entry,"sl":sl,"R":R,"pos20":pos20,"rsi":rsicj})
...
S4=[x for x in B if x["pos20"]>=qpos and x["rsi"]>=qrsi]
...
with open(HERE/"substrate4_window.csv","w",newline="") as fh:
