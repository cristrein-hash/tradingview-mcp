#!/usr/bin/env python3
"""Plotagem CANÔNICA dos trades da estratégia ESCOLHIDA (strategy_chosen_trades.csv): long_position entry/SL/saída-real
...
def main():
    ...
    rows=list(csv.DictReader(open(HERE/"strategy_chosen_trades.csv"))); rows.sort(key=lambda r:int(r["entry_t"]))
